...
--
-- Note: rider_memberships is excluded (contains PII: city/country).
-- Run seed-memberships.sql separately after seeding if needed.
...
-- Rider memberships seed data (contains PII — DO NOT commit)
-- Generated by scripts/generate-seed.sh
--
...
rm -f "$MEMBERSHIPS_FILE.tmp" "$MEMBERSHIPS_FILE.tmp2"
...
echo ""
echo "Memberships seed: $MEMBERSHIPS_FILE (gitignored)"
