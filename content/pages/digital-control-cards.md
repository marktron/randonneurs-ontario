---
title: Digital Control Cards
slug: digital-control-cards
description: How to use Randonneurs Ontario’s digital control cards during a brevet
lastUpdated: 2026-08-29
---

Every brevet has a handful of checkpoints along the route called _controls_. At each one you collect proof that you were there: a volunteer’s signature, or a receipt from the corner store. At the finish you hand it all over, and that proof is what turns a long day on the bike into an official result. For a hundred years the thing you collected it on was a small paper card, folded into a jersey pocket and slowly dissolving in sweat.

We now have a digital version. It’s a web page on your phone with a “Check in” button beside each control. You tap it, your phone notes where you are and what time it is, and a little green stamp lands on the row. That’s it.

The rest of this page is detail, but the one thing to understand is this: the digital card never says no. Like the paper card, it just writes down what happened. If you’re early, late, out of signal, or your phone has decided it doesn’t know where it is, you can still check in. The organizer sees a note next to anything unusual and sorts it out afterward, the same way they’d squint at a smudged time on a paper card.

If you’ve never ridden a brevet, start with [What is Randonneuring?](/intro) and [Your First Brevet](/your-first-brevet). This page assumes you know roughly what you’re signing up for.

[screenshot-1]: <> 'SCREENSHOT: A phone showing the digital card mid-ride. Two controls stamped with check-in times, the next control with the solid Check in button, a couple of later controls still showing open/close times. A real event and rider name (with permission) beats placeholder text.'
...
**Test your location at home.** Open your card a few days ahead. Near the top there’s a “Test your location” button. Tap it, let your phone ask for permission, and say yes. If it says “Location works on this phone,” you’re done. If it says location is blocked, the page walks you through the settings for your phone. It takes about a minute at your kitchen table. It takes considerably longer at a Tim Hortons at dawn with cold fingers.
...
At each control after that, same thing. Roll up, stop, tap Check in. Your phone spends a few seconds finding a GPS fix (up to 45 if you’re indoors, so tap before you go in for coffee). Then the stamp lands, and the next control’s button turns solid so you can always see where you’re headed.

[screenshot-4]: <> 'SCREENSHOT: Close-up of a freshly stamped row: the green club stamp overlapping the control name, the check-in time, and the small Undo link beside it.'

Each control has a radius around it, generally 500 metres, so you don’t have to stand on a specific square of pavement. Check in from the wrong side of town and it still records, with a note that it happened outside the radius. If your phone thinks you’re at a _different_ control than the one you tapped, the page asks which one you meant before saving anything.

Tapped the wrong row? There’s an **Undo** link beside every check-in for 15 minutes. After that, ask the organizer.

## When things go wrong

Something will go wrong. Not to you, necessarily, but to someone on every ride.

**No signal.** Tap Check in anyway. The stamp appears, the row says “Waiting to sync,” and your phone holds the check-in until it finds a connection. It remembers the time you _tapped_, not the time it eventually uploads, so a control in a cellular dead zone costs you nothing. Just keep the page open. If you close the tab while offline, it won’t reload until you have signal again, which is the one real reason to keep a paper card in your pocket for now.

[screenshot-5]: <> 'SCREENSHOT: The offline banner (‘One check-in is saved on this phone and will sync automatically when you have signal. Keep this page open.’) with a row showing Waiting to sync. Airplane mode is the easy way to stage it.'
...
Something not covered here? Your ride organizer’s name and phone number are on the card itself, near the bottom. They’d rather hear from you before the ride than at kilometre 150.
